...
import { LayoutDashboard, Briefcase, PlusCircle, Users, FileText, MessageSquare, Bell } from 'lucide-react';
import { cn } from '@/lib/utils';

const NAV = [
  { href: '/company/dashboard',  label: 'Dashboard',    icon: LayoutDashboard },
  { href: '/company/post-job',   label: 'Post a Job',   icon: PlusCircle },
  { href: '/company/my-jobs',    label: 'My Jobs',      icon: Briefcase },
  { href: '/company/templates',  label: 'Templates',    icon: FileText },
  { href: '/company/profile',    label: 'Company Profile', icon: Users },
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)]">
      ...
      <aside className="hidden md:flex flex-col w-56 shrink-0 border-r border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 py-6 gap-1">
        <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3 mb-2">Company Panel</p>
